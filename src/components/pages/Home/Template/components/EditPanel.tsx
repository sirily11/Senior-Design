...
<Select
  ...
  onChange={e => {
    ...
    templateContext.graph.selectedGraph?.argumentChangeDescription(e.target.value as string, "ARGUMENT")
...
<Select
 ...
 onChange={e => {
  ...
  templateContext.update();
    ...
    {["All threats to the environment\n have been identified.", "All threats to animal life have\n been identified.", "All threats to plant life have\n been identified.", 
    "It is possible to detect evolution\n or mutation resulting in\n undesired or unwanted behavior."].map(s => (
      <MenuItem value={s} id={s}>
        {s}
      </MenuItem>
    ))}
...
<Select
 ...
 value={generalEnvironment}
  ...
  templateContext.update();
    ...
    {["Only in the lab", "An industrial\n bioreactor", "The general\n environment", 
    "Soil", "The water table", "The atmosphere", "Freshwater rivers\n or lakes", 
  "Saltwater lakes or\n oceans", "A human gut"].map(s => (
      <MenuItem value={s} id={s}>
        {s}
      </MenuItem>
    ))}
...
<Select
 ...
 onChange={e => {
  ...
  templateContext.update();
    ...
    {["Our organisims only function\n in fresh water.", "Our organisms only function\n in salt water.", "Our organisms are not intended\n for release into the environment.", 
    "Our organisms are designed to\n live within the human gut.", "Only the outputs from our\n organisms are intended for\n environmental application."].map(s => (
      <MenuItem value={s} id={s}>
        {s}
      </MenuItem>
    ))}
...
<Select
 ...
 onChange={e => {
  ...
  templateContext.update();
    ...
    {["Our " + safetyFeature + " operates\n effectively and when intended.", 
    "Our " + safetyFeature + " operates safely.", "Our " + safetyFeature + " operates\n securely and is robust to external\n attacks."].map(s => (
      <MenuItem value={s} id={s}>
        {s}
      </MenuItem>
    ))}
...
<Select
 ...
 onChange={e => {
  ...
  templateContext.update();
    ...
    {["Our lab has adequate physical security.", "Everyone on our team has proper\n safety training.",
