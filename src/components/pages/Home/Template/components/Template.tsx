...
import { NodeObj } from "../../../../models/graph";
...
//TODO: Looking into saving graph as a png or other file.
...
export default function Template() {
  ...
  const renderTemplate = (node: NodeObj, index: number) => {
  ...
  return (
    <Grid.Column width={12}>
       <Stage width={window.innerWidth / 2} height={600}>
          {template?.selectedTemplate?.nodes.map((n, index) => renderTemplate(n, index))}
      </Stage> 
    </Grid.Column>
  );
}